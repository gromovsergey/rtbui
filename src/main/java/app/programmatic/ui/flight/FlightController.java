...
import app.programmatic.ui.flight.service.FlightChartService;
...
public class FlightController extends FlightBaseController {
    private static final Integer FLIGHT_START_DAYS_AGO_LIMIT = Integer.valueOf(3);
    ...
    public List<FlightDashboardStat> getFlightDashboardStats() {
        return flightService.getDashboardStats(FLIGHT_START_DAYS_AGO_LIMIT);
    }
