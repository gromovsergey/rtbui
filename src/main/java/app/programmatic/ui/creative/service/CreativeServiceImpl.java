...
public class CreativeServiceImpl implements CreativeService {
    ...
    private static final String IMAGE_TEMPLATE_NAME = "Image (RU)";
    ...
    public List<Long> uploadCreatives(CreativeUpload creativeUpload) {
        ...
        CreativeTemplate imageTemplate = findImageTemplate(accountId);
    ...
    @Override
    public CreativeTemplate findImageTemplate(Long accountId) {
        try {
            Long templateId = jdbcOperations.queryForObject(
                    "select t.template_id " +
                            ...
                            "and t.name = ?",
                    new Object[]{accountId, IMAGE_TEMPLATE_NAME},
                    Long.class);
