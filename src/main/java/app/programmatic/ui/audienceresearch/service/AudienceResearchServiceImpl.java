...
public class AudienceResearchServiceImpl implements AudienceResearchService {
    ...
    public AudienceResearch findEager(Long id) {
        AudienceResearch result = id != null ? audienceResearchRepository.findOne(id) : null;
        if (result == null) {
    ...
    public List<AudienceResearchView> findAll() {
        return audienceResearchRepository.findByStatusNotInOrderByTargetChannelName(Status.DELETED.getLetter()).stream()
                .map(e -> {
    ...
    public AudienceResearchStat getStat(Long audienceResearchId, Long expressionChannelId) {
        AudienceResearch audienceResearch = audienceResearchRepository.findOne(audienceResearchId);
    ...
    public Long create(AudienceResearch audienceResearch) {
        ...
        ChannelEntity channel = channelRepository.findOne(audienceResearch.getTargetChannel().getId());
        ...
        audienceResearchChannelRepository.save(audienceResearch.getChannels());
    ...
    public Long update(AudienceResearch audienceResearch) {
        AudienceResearch existing = audienceResearchRepository.findOne(audienceResearch.getId());
        ...
        audienceResearch.getChannels().stream()
                ...
                .forEach( c -> {
                    AudienceResearchChannel existingChannel = audienceResearchChannelRepository.findOne(c.getId());
        ...
        List<AudienceResearchChannel> addResearchChannels = audienceResearch.getChannels().stream()
                ...
                .collect(Collectors.toList());
        audienceResearchChannelRepository.save(addResearchChannels);
    ...
    public Long updateYesterdayComment(String comment, Long id) {
        AudienceResearchChannel channel = audienceResearchChannelRepository.findOne(id);
    ...
    public Long delete(Long id) {
        AudienceResearch audienceResearch = audienceResearchRepository.findOne(id);
    ...
    private AudienceResearchChannel prePersistChannel(AudienceResearchChannel channel,
        ...
        channel.setChannel(channelRepository.findOne(channel.getChannel().getId()));
