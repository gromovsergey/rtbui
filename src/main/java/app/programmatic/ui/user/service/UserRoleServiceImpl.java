...
public class UserRoleServiceImpl implements UserRoleService {
    ...
    public Iterable<UserRole> getAvailableForCreateRoles(AccountRole accountRole) {
        switch (accountRole) {
            case AGENCY:
                return userRoleRepository.findAll(Arrays.asList(adminUserRoleId, standardUserRoleId, readOnlyUserRoleId, readOnlyPlusUserRoleId));
            case ADVERTISER:
                return userRoleRepository.findAll(Arrays.asList(advAdminUserRoleId, advStandardUserRoleId, advReadOnlyUserRoleId));
            default:
    ...
    private Long findOrCreateUserRoleId(UserRoleType roleType) {
        ...
        permissionRepository.delete(excessive);
        permissionRepository.save(missing);
